...
public class SpeciallyAbledVehicleSpot extends ParkingSpot {
    public SpeciallyAbledVehicleSpot(int index, CoordinateHelper coordinate, EntranceGate entranceGate, IParkingSpotTypeStrategy parkingSpotTypeStrategy) {

...
public class HeavyDutyVehcileSpot extends ParkingSpot {
    public HeavyDutyVehcileSpot(int index, CoordinateHelper coordinate, EntranceGate entranceGate, IParkingSpotTypeStrategy parkingSpotTypeStrategy) {

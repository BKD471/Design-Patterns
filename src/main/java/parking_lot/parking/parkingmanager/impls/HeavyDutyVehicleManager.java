...
public class HeavyDutyVehicleManager extends ParkingSpotManager {
    public HeavyDutyVehicleManager(IParkingStartegy parkingStartegy, PriorityQueue<ParkingSpot> lisOfParkingSpot) {
